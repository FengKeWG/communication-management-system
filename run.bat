...
REM 使用 gcc 编译源代码
echo 正在编译项目...
gcc -o main src/main.c src/client_manager.c src/contact_manager.c src/user_manager.c src/sales_manager.c src/communication_manager.c src/file_manager.c -I include
